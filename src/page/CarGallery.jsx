...
///////method 2
// const images = import.meta.glob("/assets/CarGallery/*.svg", {
//   eager: true,
//   import: "default",
// });

// const gallery = Object.values(images).map((image) => ({ image }));
    ...
    <div className="grid w-full grid-cols-1  md:grid-cols-3 ">
      {gallery.map((item, index) => (
        <div key={index} className="image-container overflow-hidden relative  ">
          <div
            className={`absolute w-full h-full flex flex-col items-center justify-center text-white   px- ${
              index == 4 ? "bg-transparent" : "hidden"
            }`}
          >
            ...
            <button className="pointer py-[8px] px-[28px] rounded-[8px] font-bold border-2 w-fit mt-[28px]">
              Contact
            </button>
          </div>
          <img
