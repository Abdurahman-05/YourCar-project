...
const About = () => {
  return (
    <div id="about" className="bg-[#fefefe] py-[40px] xs:py-[56px] px-4 xs:px-[30px] sm:px-[80px]">
      <h1 className="font-bold font-lora text-center text-[48px] xs:text-[64px] sm:text-[84px] md:text-[124px] sm:text-left text-[#ebebeb]">
        ABOUT US
      </h1>
      <div className="grid lg:grid-cols-2 gap-[30px] lg:gap-[45px]">
        <div className="relative font-lora">
          <h1 className="absolute text-primary font-bold font-lora text-[28px] xs:text-[34px] top-[-40px] left-[50%] transform -translate-x-1/2 sm:top-[-69px] sm:left-[-6px] sm:text-[64px] md:left-[-5px] md:top-[-86px] sm:transform-none">
            About
          </h1>
          <p className="pt-11 text-[16px] xs:text-[18px] sm:text-[20px] text-[#232730] leading-[1.6] md:leading-[1.5] lg:leading-[1.4]">
